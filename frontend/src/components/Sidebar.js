...
import { Shield, Home, CheckSquare, TrendingUp, DollarSign, Target, MessageSquare, FileText, User, LogOut } from "lucide-react";
...
export default function Sidebar({ user }) {
  ...
  return (
    <div className="w-64 bg-[#0A0A0A] border-r border-[#27272A] flex flex-col h-screen fixed left-0 top-0">
